...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("funcionario" == $this->chrt_array['tables'][0])
			return true;
		if("baja" == $this->chrt_array['tables'][0])
			return true;
		if("baja_con" == $this->chrt_array['tables'][0])
			return true;
		if("cta_banc" == $this->chrt_array['tables'][0])
			return true;
		if("t_descuentos" == $this->chrt_array['tables'][0])
			return true;
		if("t_ingreso" == $this->chrt_array['tables'][0])
			return true;
		if("identificacion_puesto" == $this->chrt_array['tables'][0])
			return true;
		if("old_cas" == $this->chrt_array['tables'][0])
			return true;
		if("t_planilla" == $this->chrt_array['tables'][0])
			return true;
		if("t_planilla" == $this->chrt_array['tables'][0])
			return true;
		if("t_planilla" == $this->chrt_array['tables'][0])
			return true;
		if("t_salario_minimo" == $this->chrt_array['tables'][0])
			return true;
		if("t_asignaciones" == $this->chrt_array['tables'][0])
			return true;
		if("t_caja" == $this->chrt_array['tables'][0])
			return true;
		if("permanente" == $this->chrt_array['tables'][0])
			return true;
		if("char_per" == $this->chrt_array['tables'][0])
			return true;
		if("contrato" == $this->chrt_array['tables'][0])
			return true;
		if("soc_secu" == $this->chrt_array['tables'][0])
			return true;
		if("t_tributaria" == $this->chrt_array['tables'][0])
			return true;
		if("t_tributaria" == $this->chrt_array['tables'][0])
			return true;
		if("t_asignaciones" == $this->chrt_array['tables'][0])
			return true;
		if("t_documentos" == $this->chrt_array['tables'][0])
			return true;
		if("t_ufv" == $this->chrt_array['tables'][0])
			return true;
		if("t_planilla_c" == $this->chrt_array['tables'][0])
			return true;
		if("t_planilla_h" == $this->chrt_array['tables'][0])
			return true;
		if("t_mes_activo" == $this->chrt_array['tables'][0])
			return true;
		if("t_planilla_c_mayores" == $this->chrt_array['tables'][0])
			return true;
		if("t_planilla_c" == $this->chrt_array['tables'][0])
			return true;
		if("t_planilla_c" == $this->chrt_array['tables'][0])
		...
		if("old_cas" == $this->chrt_array['tables'][0])
			return true;
		if("t_sigep" == $this->chrt_array['tables'][0])
			return true;
		if("t_sigep" == $this->chrt_array['tables'][0])
			return true;
		if("t_facturas110" == $this->chrt_array['tables'][0])
			return true;
		if("t_facturas110" == $this->chrt_array['tables'][0])
			return true;
		if("t_multas" == $this->chrt_array['tables'][0])
			return true;
		if("t_doc_file" == $this->chrt_array['tables'][0])
			return true;
		if("t_tipo_documento" == $this->chrt_array['tables'][0])
			return true;
		if("t_tipo_multa" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
