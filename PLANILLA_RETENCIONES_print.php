...
require_once("include/PLANILLA_RETENCIONES_variables.php");
...
$page_layouts["PLANILLA_RETENCIONES_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=PLANILLA_RETENCIONES.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=PLANILLA_RETENCIONES.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("haber_basico_fieldheader", true);
$xt->assign("haber_percibido_fieldheader", true);
$xt->assign("bono_ant_fieldheader", true);
$xt->assign("total_ganado_fieldheader", true);
$xt->assign("retenciones_fieldheader", true);
