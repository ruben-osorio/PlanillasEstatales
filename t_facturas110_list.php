...
require_once("include/t_facturas110_variables.php");
...
$page_layouts["t_facturas110_list"] = $layout;
...
$layout = new TLayout("masterlist", "Rounded1Coral1", "MobileCoral1");
$layout->version = 2;
...
$page_layouts["funcionario_masterlist"] = $layout;
