...
$layout = new TLayout("print", "ExtravaganzaCoral1", "MobileCoral1");
$layout->version = 2;
...
$page_layouts["t_planilla_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "t_planilla" );
