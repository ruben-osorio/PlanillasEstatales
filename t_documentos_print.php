...
$layout = new TLayout("print", "Rounded1Coral1", "MobileCoral1");
$layout->version = 2;
...
$page_layouts["t_documentos_print"] = $layout;
...
$layout = new TLayout("masterprint", "Rounded1Coral1", "MobileCoral1");
$layout->version = 2;
...
$page_layouts["funcionario_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "t_documentos" );
