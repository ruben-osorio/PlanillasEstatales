...
require_once("include/PERSONAL_REGISTRADO_EN_SIGEP_variables.php");
...
$page_layouts["PERSONAL_REGISTRADO_EN_SIGEP_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=PERSONAL_REGISTRADO_EN_SIGEP.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=PERSONAL_REGISTRADO_EN_SIGEP.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
