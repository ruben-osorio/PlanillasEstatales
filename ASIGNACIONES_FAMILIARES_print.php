...
require_once("include/ASIGNACIONES_FAMILIARES_variables.php");
...
$page_layouts["ASIGNACIONES_FAMILIARES_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=ASIGNACIONES_FAMILIARES.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=ASIGNACIONES_FAMILIARES.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("id_asig_fieldheader", true);
$xt->assign("fecha_nac_fieldheader", true);
$xt->assign("fecha_pres_fieldheader", true);
$xt->assign("pre_num_paq_fieldheader", true);
$xt->assign("paq_monto_fieldheader", true);
$xt->assign("sub_natalidad_fieldheader", true);
$xt->assign("lac_num_paq_fieldheader", true);
$xt->assign("lac_monto_fieldheader", true);
$xt->assign("sepelio_fieldheader", true);
$xt->assign("sub_total_pago_sedem_fieldheader", true);
