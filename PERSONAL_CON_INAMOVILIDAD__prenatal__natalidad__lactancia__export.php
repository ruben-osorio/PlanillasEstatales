...
$layout = new TLayout("export", "Rounded1Coral1", "MobileCoral1");
$layout->version = 2;
...
$page_layouts["PERSONAL_CON_INAMOVILIDAD__prenatal__natalidad__lactancia__export"] = $layout;
...
if( @$_REQUEST["a"] != "" )
{
	...
	if (@$_REQUEST["mdelete"])
	{
		...
		{
			$keys=array();
			$keys["id_func"] = refine($_REQUEST["mdelete1"][mdeleteIndex($ind)]);
			$selected_recs[] = $keys;
		}
	}
