...
require_once("include/baja_variables.php");
...
$layout = new TLayout("export", "AvenueCoral1", "MobileCoral1");
$layout->version = 2;
...
$page_layouts["baja_export"] = $layout;
...
if( @$_REQUEST["a"] != "" )
{
	...
	if (@$_REQUEST["mdelete"])
	{
		...
		{
			$keys=array();
			$keys["id_baja"] = refine($_REQUEST["mdelete1"][mdeleteIndex($ind)]);
			$selected_recs[] = $keys;
		}
	}
