...
require_once("include/LISTADO_DE_CUMPLEA_EROS_variables.php");
...
$page_layouts["LISTADO_DE_CUMPLEA_EROS_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=LISTADO_DE_CUMPLEA_EROS.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=LISTADO_DE_CUMPLEA_EROS.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
