...
$page_layouts["t_multas_print"] = $layout;
...
$page_layouts["t_descuentos_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "t_multas" );
