...
require_once("include/PERSONAL_CON_INAMOVILIDAD__prenatal__natalidad__lactancia__variables.php");
...
$page_layouts["PERSONAL_CON_INAMOVILIDAD__prenatal__natalidad__lactancia__rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=PERSONAL_CON_INAMOVILIDAD__prenatal__natalidad__lactancia_.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=PERSONAL_CON_INAMOVILIDAD__prenatal__natalidad__lactancia_.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("id_func_fieldheader", true);
...
$xt->assign("asig_familiar_fieldheader", true);
$xt->assign("pre_natal_fieldheader", true);
$xt->assign("natalidad_fieldheader", true);
$xt->assign("lactancia_fieldheader", true);
$xt->assign("mes_fieldheader", true);
$xt->assign("gestion_fieldheader", true);
$xt->assign("tipo_funcionario_fieldheader", true);
