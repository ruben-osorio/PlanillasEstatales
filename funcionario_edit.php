...
$layout = new TLayout("edit_basic_2col_center", "Rounded1Coral1", "MobileCoral1");
$layout->version = 2;
...
$page_layouts["funcionario_edit"] = $layout;
...
$layout->blocks["top"][] = "hmenu";
$page_layouts["identificacion_puesto_list"] = $layout;
...
$keys = array();
$keys["id_func"] = postvalue("editid1");
