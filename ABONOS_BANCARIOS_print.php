...
require_once("include/ABONOS_BANCARIOS_variables.php");
...
$page_layouts["ABONOS_BANCARIOS_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=ABONOS_BANCARIOS.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=ABONOS_BANCARIOS.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("num_ac_fieldheader", true);
