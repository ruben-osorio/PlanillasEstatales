...
$layout = new TLayout("add_basic_2col_center", "Rounded1Coral1", "MobileCoral1");
$layout->version = 2;
...
$page_layouts["funcionario_add"] = $layout;
...
$layout = new TLayout("list_centered_vert", "Rounded1Coral1", "MobileCoral1");
$layout->version = 2;
...
$page_layouts["t_ingreso_list"] = $layout;
...
$layout->blocks["top"][] = "hmenu";
$page_layouts["t_descuentos_list"] = $layout;
...
$sql = "INSERT INTO permanente (id_per, id_func, date_ent, status, TIPO, item) VALUES (1699, 1699, '2021-09-30', 1, 'PERMANENTE','124567')";
