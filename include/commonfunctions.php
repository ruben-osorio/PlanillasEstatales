...
function checkTableName($shortTName, $type=false)
{
	...
	if ("funcionario" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("baja" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("baja_con" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("cta_banc" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("t_descuentos" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("t_ingreso" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("identificacion_puesto" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("old_cas" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ABONOS_BANCARIOS" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("AFP_PREVISION" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("AFP_FUTURO" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("t_salario_minimo" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("t_asignaciones" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("t_caja" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("permanente" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("char_per" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("contrato" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("soc_secu" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("t_tributaria" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PLANILLA_TRIBUTARIA" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("ASIGNACIONES_FAMILIARES" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("t_documentos" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("t_ufv" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("t_planilla_c" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("t_planilla_h" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("t_mes_activo" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("t_planilla_c_mayores" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PLANILLA_RETENCIONES" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("LISTADO_DE_CUMPLEA_EROS" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("PERSONAL_CON_INAMOVILIDAD__prenatal__natalidad__lactancia_" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("PERSONAL_CON_CERTIFICADOS_DEL_CAS" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("t_sigep" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("PERSONAL_REGISTRADO_EN_SIGEP" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("t_facturas110" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("GENERACI_N_DEL_PERSONAL_QUE_PRESENTA_FACTURAS_PARA_LA_RETENCI_N_IMPOSITIVA" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("t_multas" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("t_doc_file" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("t_tipo_documento" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("t_tipo_multa" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	$arr = array();
		...
		$arr[]="t_descuentos";
		$arr[]="t_ingreso";
		$arr[]="identificacion_puesto";
		$arr[]="old_cas";
		$arr[]="ABONOS BANCARIOS";
		$arr[]="AFP-PREVISION";
		$arr[]="AFP-FUTURO";
		$arr[]="t_salario_minimo";
		$arr[]="t_asignaciones";
		$arr[]="t_caja";
		$arr[]="permanente";
		$arr[]="char_per";
		...
		$arr[]="soc_secu";
		$arr[]="t_tributaria";
		$arr[]="PLANILLA TRIBUTARIA";
		$arr[]="ASIGNACIONES FAMILIARES";
		$arr[]="t_documentos";
		$arr[]="t_ufv";
		$arr[]="t_planilla_c";
		$arr[]="t_planilla_h";
		$arr[]="t_mes_activo";
		$arr[]="t_planilla_c_mayores";
		$arr[]="PLANILLA RETENCIONES";
		$arr[]="LISTADO DE CUMPLEAÑEROS";
		$arr[]="PERSONAL CON INAMOVILIDAD (prenatal, natalidad, lactancia)";
		$arr[]="PERSONAL CON CERTIFICADOS DEL CAS";
		$arr[]="t_sigep";
		$arr[]="PERSONAL REGISTRADO EN SIGEP";
		$arr[]="t_facturas110";
		$arr[]="GENERACIÓN DEL PERSONAL QUE PRESENTA FACTURAS PARA LA RETENCIÓN IMPOSITIVA";
		$arr[]="t_multas";
		$arr[]="t_doc_file";
		$arr[]="t_tipo_documento";
		$arr[]="t_tipo_multa";
	return $arr;
}
...
//	default permissions	
	if($table=="identificacion_puesto")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
...
//	default permissions	
	if($table=="ABONOS BANCARIOS")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
//	default permissions	
	if($table=="AFP-PREVISION")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
...
//	default permissions	
	if($table=="t_salario_minimo")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
//	default permissions	
	if($table=="t_asignaciones")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
...
//	default permissions	
	if($table=="t_tributaria")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
//	default permissions	
	if($table=="PLANILLA TRIBUTARIA")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
//	default permissions	
	if($table=="ASIGNACIONES FAMILIARES")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
//	default permissions	
	if($table=="t_documentos")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
...
//	default permissions	
	if($table=="t_planilla_c")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
//	default permissions	
	if($table=="t_planilla_h")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
//	default permissions	
	if($table=="t_mes_activo")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
//	default permissions	
	if($table=="t_planilla_c_mayores")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
//	default permissions	
	if($table=="PLANILLA RETENCIONES")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
//	default permissions	
	if($table=="LISTADO DE CUMPLEAÑEROS")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
//	default permissions	
	if($table=="PERSONAL CON INAMOVILIDAD (prenatal, natalidad, lactancia)")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
//	default permissions	
	if($table=="PERSONAL CON CERTIFICADOS DEL CAS")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
...
//	default permissions	
	if($table=="PERSONAL REGISTRADO EN SIGEP")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
//	default permissions	
	if($table=="t_facturas110")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
//	default permissions	
	if($table=="GENERACIÓN DEL PERSONAL QUE PRESENTA FACTURAS PARA LA RETENCIÓN IMPOSITIVA")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
...
//	default permissions	
	if($table=="t_tipo_documento")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
//	default permissions	
	if($table=="t_tipo_multa")
	{
		// grant all by default
		return "ADESPI".$extraPerm;	
	}
