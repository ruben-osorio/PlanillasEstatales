...
function DisplayMasterTableInfoForPrint_t_descuentos($params)
{
	global $cman;
	...
	$layout = GetPageLayout("t_descuentos", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("t_descuentos", "masterprint"));
}
