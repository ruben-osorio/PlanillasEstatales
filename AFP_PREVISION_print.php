...
require_once("include/AFP_PREVISION_variables.php");
...
$page_layouts["AFP_PREVISION_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=AFP_PREVISION.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=AFP_PREVISION.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("total_ganado_fieldheader", true);
$xt->assign("afp_10_fieldheader", true);
$xt->assign("afp_riesgo_1_71_fieldheader", true);
$xt->assign("afp_05_fieldheader", true);
$xt->assign("afp_ap_sol_0_5_fieldheader", true);
$xt->assign("ans_1_fieldheader", true);
$xt->assign("seguro_pat_10_fieldheader", true);
$xt->assign("riesgo_pat_171_fieldheader", true);
$xt->assign("pro_vivienda_pat_2_fieldheader", true);
$xt->assign("ap_pat_sol_3_fieldheader", true);
$xt->assign("sub_total_fieldheader", true);
$xt->assign("afp_fieldheader", true);
